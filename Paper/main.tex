...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.48\columnwidth]{images/im1.png}
	\centering{\caption{\label{microchip} A microfluidic rectilinear channel side = 320~$[\rm~\mu m]$ and length = 16~$[\rm mm]$.}}
\end{figure}
