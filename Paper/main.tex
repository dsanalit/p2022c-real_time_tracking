...
\begin{figure}[t]
	...
	\centering{\caption{\label{Beads}The velocity trends $<V_x(t)>$ obtained in the experimental condition with { $f_i= 0.1 Hz$, $A \in{0.1 ml/min}$: (a) silica beads in PBS and (b) silica beads in glycerol-water solution.}}}
\end{figure}
